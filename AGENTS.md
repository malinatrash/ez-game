...
- Production размещён в Vercel-проекте `malinatrashs-projects/svo-game`: https://svo-game-three.vercel.app
- Локальная привязка хранится в `.vercel/project.json`; каталог `.vercel` добавлен в `.gitignore` и не коммитится.
